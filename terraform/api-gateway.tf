...
# ---------------------------------------------------------------------------------------------------------------------
# API GATEWAY: `/auth/configure-mfa` DAPPBOT CONFIGURE MFA API
# ---------------------------------------------------------------------------------------------------------------------
resource "aws_api_gateway_resource" "dappbot_auth_configure_mfa" {
  rest_api_id = aws_api_gateway_rest_api.dapp_api.id
  parent_id   = aws_api_gateway_resource.dappbot_auth.id
  path_part   = "configure-mfa"
}

resource "aws_api_gateway_method" "dappbot_auth_configure_mfa_any" {
  rest_api_id = aws_api_gateway_rest_api.dapp_api.id
  resource_id = aws_api_gateway_resource.dappbot_auth_configure_mfa.id
  http_method = "ANY"
...
resource "aws_api_gateway_integration" "dappbot_auth_configure_mfa_any" {
  rest_api_id = aws_api_gateway_rest_api.dapp_api.id
  resource_id = aws_api_gateway_resource.dappbot_auth_configure_mfa.id
  http_method = aws_api_gateway_method.dappbot_auth_configure_mfa_any.http_method

  integration_http_method = "POST"
  type                    = "AWS_PROXY"
  uri                     = local.dappbot_config_lambda_uri
...
# ---------------------------------------------------------------------------------------------------------------------
# API GATEWAY: `/auth/configure-mfa` CORS PREFLIGHT HANDLING
# ---------------------------------------------------------------------------------------------------------------------

resource "aws_api_gateway_method" "dappbot_auth_configure_mfa_cors" {
  rest_api_id = aws_api_gateway_rest_api.dapp_api.id
  resource_id = aws_api_gateway_resource.dappbot_auth_configure_mfa.id
  http_method = "OPTIONS"
...
resource "aws_api_gateway_method_response" "dappbot_auth_configure_mfa_cors" {
  rest_api_id = aws_api_gateway_rest_api.dapp_api.id
  resource_id = aws_api_gateway_resource.dappbot_auth_configure_mfa.id
  http_method = aws_api_gateway_method.dappbot_auth_configure_mfa_cors.http_method
  status_code = "200"
  ...
  depends_on = [aws_api_gateway_method.dappbot_auth_configure_mfa_cors]
}

resource "aws_api_gateway_integration" "dappbot_auth_configure_mfa_cors" {
  rest_api_id = aws_api_gateway_rest_api.dapp_api.id
  resource_id = aws_api_gateway_resource.dappbot_auth_configure_mfa.id
  http_method = aws_api_gateway_method.dappbot_auth_configure_mfa_cors.http_method
...
resource "aws_api_gateway_integration_response" "dappbot_auth_configure_mfa_cors" {
  rest_api_id = aws_api_gateway_rest_api.dapp_api.id
  resource_id = aws_api_gateway_resource.dappbot_auth_configure_mfa.id
  http_method = aws_api_gateway_method.dappbot_auth_configure_mfa_cors.http_method
  status_code = aws_api_gateway_method_response.dappbot_auth_configure_mfa_cors.status_code
  ...
  depends_on = [
    ...
    aws_api_gateway_method_response.dappbot_auth_configure_mfa_cors
  ]
}
...
# Configure MFA API
resource "aws_lambda_permission" "api_gateway_invoke_dappbot_config_lambda" {
  statement_id  = "AllowExecutionFromAPIGateway"
  action        = "lambda:InvokeFunction"
  function_name = aws_lambda_function.dappbot_config_api_lambda.function_name
  principal     = "apigateway.amazonaws.com"
